defmodule RepRivals.Library do
  ...
  The creator is automatically added as an "accepted" participant.
  ...
  ## Examples
      ...
      iex> create_challenge_participants_with_status(challenge_id, [1], "accepted")
      {:ok, [%ChallengeParticipant{}, ...]}
  ...
  def create_challenge_result(attrs \\ %{}) do
    ...
    participant =
      get_challenge_participant_by_challenge_and_user!(attrs.challenge_id, attrs.user_id)
